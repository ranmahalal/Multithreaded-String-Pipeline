...
typedef const char* (*plugin_get_name_func_t)(void); //need to get rid of this
...
typedef struct {
    ...
    plugin_get_name_func_t get_name; // I added this - must check it - get rid of it
    char* name;   
     void* handle
} plugin_handle_t;
...
int main(int argc, char* argv[]) {
    ...
    //check that all plugin names are valid
    ...
    char line[1025]; //here i need to make sure that 1025 is ok. that not 1024 or 1026.
